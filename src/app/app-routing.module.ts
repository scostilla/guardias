...
const routes: Routes = [
  ...
  {
    path: 'professional-form-delet',
    component: ProfessionalFormDeletComponent,
  },
  ...
  {
    path: 'professional-dh-junio/:id',
    component: ProfessionalDhJunioComponent,
  },
  {
    path: 'professional-plantilla-dh/:id',
    component: ProfessionalPlantillaDhComponent,
  },
  ...
  {
    path: 'ddjj-contrafactura-tot-ap',
    component: DdjjContrafacturaTotApComponent,
  },
  {
    path: 'ddjj-contrafactura-tot-rec',
    component: DdjjContrafacturaTotRecComponent,
  },
  { path: 'ddjj-cargoyagrup-tot', component: DdjjCargoyagrupTotComponent },
  {
    path: 'ddjj-cargoyagrup-total-ap',
    component: DdjjCargoyagrupTotalApComponent,
  },
  {
    path: 'ddjj-cargoyagrup-total-rec',
    component: DdjjCargoyagrupTotalRecComponent,
  },
  {
    path: 'ddjj-tentativo',
    component: DdjjTentativoComponent,
  ...
  {
    path: 'cronograma-form-agregar',
    component: CronogramaFormAgregarComponent,
  },
  ...
  { path: '', component: LoginComponent },
  {
    path: 'professional-dh-junio-asis/:id',
    component: ProfessionalDhJunioAsisComponent,
  },
  {
    path: 'ddjj-tentativo',
    component: DdjjTentativoComponent,
