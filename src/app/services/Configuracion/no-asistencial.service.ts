...
export class NoAsistencialService {
  ...
  public listNoAsistencialSummary(): Observable<NoAsistencialListDto[]> {
    return this.httpClient.get<NoAsistencialListDto[]>(this.noasistencialesURL + 'listNoAsistencialSummary')
  }
