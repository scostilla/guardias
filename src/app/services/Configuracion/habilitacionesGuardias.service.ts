...
export class HabilitacionesGuardiasService {
 ...
 /*  public listAsistencialesByEfectorAndTG(idEfector: number, tipoGuardia: string): Observable<AsistencialSummaryDto[]> {
  return this.httpClient.get<AsistencialSummaryDto[]>(`${this.asistencialesURL}listAsistencialesByEfectorAndTG/${idEfector}/${tipoGuardia}`);
} */
}
