...
export class AsistencialService {
  ...
  public ConPendientes(idEfector: number, tipoGuardia: number): Observable<AsistencialSummaryDto[]> {
    return this.httpClient.get<AsistencialSummaryDto[]>(`${this.asistencialesURL}asistencialesConPendientes/${idEfector}/${tipoGuardia}`);
  }
