...
@Component({
  selector: 'app-legajo-person-edit',
  templateUrl: './legajo-person-edit.component.html',
  styleUrls: ['./legajo-person-edit.component.css']
})

export class LegajoPersonEditComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<LegajoPersonEditComponent>,
