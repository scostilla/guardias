...
export class RmensualCargoyagrupComponent implements OnInit, OnDestroy {
  ...
  loadRegistrosMensuales(): void {
    ...
    const request$ = this.selectedServicio
      ? this.registroMensualService.listCargoyagrupAndServicio(anio, mes, idEfector, this.selectedServicio)
      : this.registroMensualService.listCargoyagrup(anio, mes, idEfector);
