...
@Component({
  selector: 'app-rmensual-seleccion',
  templateUrl: './rmensual-seleccion.component.html',
  styleUrls: ['./rmensual-seleccion.component.css']
})

export class RmensualSeleccionComponent {
  hospitales: Hospital[]=[];
  fechaActual?: string;
  ...
  navigateToCargoyAgrup() {
    this.router.navigate(['/rmensual-cargoyagrup']);
  }

  navigateToExtra() {
    this.router.navigate(['/rmensual-extra']);
  }
