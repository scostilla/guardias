...
@Component({
  selector: 'app-registro-actividades-e',
  templateUrl: './registro-actividades-e.component.html',
  styleUrls: ['./registro-actividades-e.component.css']
})
export class RegistroActividadesEComponent implements OnInit, OnDestroy {
