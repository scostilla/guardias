...
if (navigation?.extras.state) {
  ...
  console.log('habilitaciones guardias', this.asistencial?.habilitacionesGuardias);
...
console.log('habilitaciones generales', this.asistencial?.habilitacionesGenerales);
...
const efectoresFiltradosGeneral = this.asistencial?.habilitacionesGenerales
        ...
        console.log('efectores',efectoresFiltradosGeneral )
