...
@Component({
  selector: 'app-autoridad-selector',
  templateUrl: './autoridad-selector.component.html',
  styleUrls: ['./autoridad-selector.component.css']
})
export class AutoridadSelectorComponent implements OnInit {
