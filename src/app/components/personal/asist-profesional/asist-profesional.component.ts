...
@Component({
  selector: 'app-asist-profesional',
  templateUrl: './asist-profesional.component.html',
  styleUrls: ['./asist-profesional.component.css']
})
export class AsistProfesionalComponent implements OnInit, OnDestroy {
  ...
  obtenerParametroRuta() {
    ...
    this.route.queryParams.subscribe(params => {
      this.selectedHospitalId = params['hospital'] ? +params['hospital'] : 38;
